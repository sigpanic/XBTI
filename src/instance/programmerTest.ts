  ...
  personalityTypes: [
    {
      id: 'dead_frontend',
      name: '已死的前端兄弟',
      description: '你是一个经历了无数次"前端已死"言论轰炸的前端工程师。从WordPress模板到Webflow，从GPT-4到Gemini 3，每次新技术出现都有人宣布前端已死。你已经麻木了，知道只要甲方还会半夜改需求，只要还有安卓碎片化，只要CSS还存在，你就有饭吃。你表面上对新技术嗤之以鼻，暗地里却偷偷学习，生怕被时代抛弃。',
      meme: '已死勿扰，代码随缘',
      template: {
        ai_dependency: 1.0,
